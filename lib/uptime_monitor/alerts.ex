defmodule UptimeMonitor.Alerts do
  ...
  """
  @spec create_notification_channel(Tenant.t(), map()) :: {:ok, NotificationChannel.t()} | {:error, any()}
  ...
  """
  @spec delete_notification_channel(Tenant.t(), pos_integer()) :: {:ok, NotificationChannel.t()} | {:error, any()}
  ...
  """
  @spec create_platform_notification(pos_integer(), map()) :: {:ok, PlatformNotification.t()} | {:error, any()}
  ...
  """
  @spec mark_notification_as_read(pos_integer(), pos_integer()) :: {:ok, PlatformNotification.t()} | {:error, any()}
  ...
  """
  @spec dispatch_incident_alert(UptimeMonitor.Incidents.Incident.t(), :opened | :resolved) :: {:ok, pid()}
