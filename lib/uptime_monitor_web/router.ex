defmodule UptimeMonitorWeb.Router do
  use UptimeMonitorWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {UptimeMonitorWeb.Layouts, :root}
  ...
  if Application.compile_env(:uptime_monitor, :dev_routes) do
